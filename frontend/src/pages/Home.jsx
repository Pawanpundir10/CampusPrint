    ...
    <div>
      ...
      <section className="relative overflow-hidden bg-gray-950 text-white py-24 sm:py-32">
        ...
        <div className="relative max-w-5xl mx-auto px-6 text-center">
          ...
          <p className="text-white/60 text-xl max-w-xl mx-auto mb-10 anim-fade-up delay-2">
            Upload PDFs, choose settings, pay online — pick up when ready. No queues. No chaos.
          </p>
      ...
      <section className="max-w-5xl mx-auto px-6 py-24">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <Feat accent="bg-blue-600" icon="3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z"
            title="Pay Online" text="Secure Razorpay integration — UPI, cards, net banking. Or pay cash at collection."/>
          ...
          <Feat accent="bg-red-500" icon="16 15v-1a4 4 0 00-4-4H8m0 0l3 3m-3-3l3-3m9 14V5a2 2 0 00-2-2H6a2 2 0 00-2 2v16l4-2 2 2 2-2 2 2 2-2 4 2z"
            title="Instant Refunds" text="Cancel pending orders. If you paid online, Razorpay refunds your money automatically."/>
        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="grid sm:grid-cols-3 gap-6">
            {[
              ...
              { n:"03", t:"Pay & collect",   d:"Pay online via Razorpay or at the counter. Collect when it's ready." },
            ].map(({ n, t, d }) => (
